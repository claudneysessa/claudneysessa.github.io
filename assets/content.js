...
(function () {
  ...
  var TEXT = {
    ...
    en: {
      ...
      introC: " — the processing happens on your own device, or you talk straight to the service with your own key. Most are open source and run in the browser, with a live demo. The exceptions are stated on their own cards: a system delivered to a client, closed source, and three projects that did not start as mine — forks I brought back to life, with the original author named.",
      codeLabel: "code",
